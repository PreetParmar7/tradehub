...
SECRET_KEY = "django-insecure-ln9-#w^!#)k(m)drffxy^#_b74j5@%=94%v&%4&o-ab(a7ho91"
...
# This overrides the default if a DATABASE_URL env var exists (which Render provides)
